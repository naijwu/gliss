...
const Table = (props: any) => {
    ...
    const { columns, data, fnEditCell, fnDeleteRow, readOnly = null } = props;
    ...
    return (
        <table className='table'>
            ...
            {readOnly?.map((item: any, index: any) => {
                return (
                    <Row key={index} readOnly={true}>
                            ...
                            return (key == 'x') ? (
                                ...
                                <td key={i}>
                                    <input 
                                      ...
                                      type="text" 
                                      value={item[key]} 
                                      onChange={(e)=>fnEditCell(e.target.value, key, index)} />
                                </td>
                            )
                        })}
                    </Row>
